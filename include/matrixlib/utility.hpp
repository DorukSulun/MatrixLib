...
namespace matrixlib
{
    ...
    bool isDiagonal(const Matrix& matrix);                                                          // Checks if the matrix is an diagonal matrix   
    ...
    bool areScalarRows(const Matrix& matrix,unsigned short sourceRow,unsigned short targetRow);     // Checks if the rows are scalar multiple
